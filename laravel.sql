...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 21, 2023 at 08:52 AM
...
INSERT INTO `checkouts` (`id`, `cart_data`, `customer_id`, `order_note`, `txnid`, `status`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, '', 3, NULL, 'SSLCZ_TXN_6583eb097fb06', 1, '2023-12-21 01:36:41', '2023-12-21 01:36:45', NULL);
...
(3, 'RS123', '15.00', '2023-12-19', '2024-12-26', '2023-12-18 23:19:08', '2023-12-18 23:19:08', NULL);
...
(3, 'aaaaaaaaaaaaaaaaa', NULL, 'raihan@gmail.com', '010556', NULL, '$2y$12$pOCVSQTlINHUdamr4OWa5ew/gChvDnZZpbhsNGhAQvZfjcC5CSCi.', NULL, 0, 1, NULL, '2 no gate', NULL, '2023-12-05 22:36:13', '2023-12-05 22:36:13', NULL),
(4, 'aaaaaaaaaaaaaafdgdaaa', NULL, 'jason@gmail.com', '01555', NULL, '$2y$12$TGlfWNw5pqYdeyFNuQv6d.nqprD.SPzx75XYbkMwV1s4eCO3dqO06', NULL, 0, 1, NULL, '2 no gate', NULL, '2023-12-05 22:38:26', '2023-12-05 22:38:26', NULL),
(5, 'patric', NULL, 'patric@gmail.com', '01885', NULL, '$2y$12$HAwgD2hW9amb6D5nrnzvOOV1.hyvHQRpSpLN3h9Y4wSBHq3mnEoE.', NULL, 0, 1, NULL, '2 no gate', NULL, '2023-12-08 21:24:55', '2023-12-08 21:24:55', NULL);
...
(22, '2023_12_02_055926_create_payments_table', 14),
(24, '2023_11_29_042951_create_orders_table', 15),
(25, '2023_11_30_041541_create_order_details_table', 15),
(26, '2023_12_11_062910_create_checkouts_table', 15);
...
INSERT INTO `orders` (`id`, `customer_id`, `sub_amount`, `discount`, `total_amount`, `payment_status`, `delivery_status`, `order_date`, `delivery_date`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 3, '1199.00', '179.85', '1019.15', 1, 2, '2023-12-21', '2023-12-21', '2023-12-21 01:39:37', '2023-12-21 01:48:59', NULL);
...
INSERT INTO `order_details` (`id`, `product_id`, `order_id`, `quantity`, `price`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 2, 1, '1.00', '1199.00', '2023-12-21 01:39:37', '2023-12-21 01:39:37', NULL);
...
INSERT INTO `payments` (`id`, `customer_id`, `currency`, `currency_code`, `amount`, `currency_value`, `method`, `txnid`, `status`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 3, 'BDT', 'BDT', '1019.15', '1', 'SSLCommerz', 'SSLCZ_TXN_6583eb097fb06', 1, '2023-12-21 01:36:41', '2023-12-21 01:38:48', NULL);
