...
<main class="main">
    <div class="page-header text-center"
        ...
        <div class="container">
            <h1 class="page-title">Choose Your Products<span>Shop</span></h1>
        </div><!-- End .container -->
    </div><!-- End .page-header -->
                        ...
                        <div class="row justify-content-center">
                            <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                                <div class="product product-7 text-center">
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-title"><a href="{{route('productDetails')}}">Brown paperbag
                                                waist pencil skirt</a></h3><!-- End .product-title -->
                                        ...
                                        <div class="product-nav product-nav-thumbs">
                                            ...
                                            <a href="#">
                                                <img src="{{asset('public/frontend/assets/images/products/product-4-2-thumb.jpg')}}"
                                                    alt="product desc">
                                            </a>
                            ...
                            <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                                <div class="product product-7 text-center">
                                    ...
                                    <div class="product-body">
                                        ...
                                        <div class="product-nav product-nav-thumbs">
                                            <a href="#" class="active">
                                                <img src="{{asset('public/frontend/assets/images/products/product-5-thumb.jpg')}}"
                                                    alt="product desc">
                                            </a>
                                            <a href="#">
                                                <img src="{{asset('public/frontend/assets/images/products/product-5-2-thumb.jpg')}}"
                                                    alt="product desc">
                                            </a>
                                        </div><!-- End .product-nav -->
                                    </div><!-- End .product-body -->
                            ...
                            <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                                <div class="product product-7 text-center">
                                    ...
                                    <div class="product-body">
                                        ...
                                        <div class="product-nav product-nav-thumbs">
                                            <a href="#" class="active">
                                                <img src="{{asset('public/frontend/assets/images/products/product-8-thumb.jpg')}}"
                                                    alt="product desc">
                                            </a>
                                            <a href="#">
                                                <img src="{{asset('public/frontend/assets/images/products/product-8-2-thumb.jpg')}}"
                                                    alt="product desc">
                                            </a>
                                        </div><!-- End .product-nav -->
                                    </div><!-- End .product-body -->
                            ...
                            <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                                <div class="product product-7 text-center">
                                    ...
                                    <div class="product-body">
                                        ...
                                        <div class="product-nav product-nav-thumbs">
                                            <a href="#" class="active">
                                                <img src="{{asset('public/frontend/assets/images/products/product-9-thumb.jpg')}}"
                                                    alt="product desc">
                                            </a>
                                            <a href="#">
                                                <img src="{{asset('public/frontend/assets/images/products/product-9-2-thumb.jpg')}}"
                                                    alt="product desc">
                                            </a>
                                            <a href="#">
                                                <img src="{{asset('public/frontend/assets/images/products/product-9-3-thumb.jpg')}}"
                                                    alt="product desc">
                                            </a>
                                        </div><!-- End .product-nav -->
                                    </div><!-- End .product-body -->
                            ...
                            <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                                <div class="product product-7 text-center">
                                    ...
                                    <div class="product-body">
                                        ...
                                        <div class="product-nav product-nav-thumbs">
                                            <a href="#" class="active">
                                                <img src="{{asset('public/frontend/assets/images/products/product-11-thumb.jpg')}}"
                                                    alt="product desc">
                                            </a>
                                            <a href="#">
                                                <img src="{{asset('public/frontend/assets/images/products/product-11-2-thumb.jpg')}}"
                                                    alt="product desc">
                                            </a>

                                            <a href="#">
                                                <img src="{{asset('public/frontend/assets/images/products/product-11-3-thumb.jpg')}}"
                                                    alt="product desc">
                                            </a>
                                        </div><!-- End .product-nav -->
                                    </div><!-- End .product-body -->
                            ...
                            <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                                <div class="product product-7 text-center">
                                    ...
                                    <div class="product-body">
                                        ...
                                        <div class="product-nav product-nav-thumbs">
                                            <a href="#" class="active">
                                                <img src="{{asset('public/frontend/assets/images/products/product-13-thumb.jpg')}}"
                                                    alt="product desc">
                                            </a>
                                            <a href="#">
                                                <img src="{{asset('public/frontend/assets/images/products/product-13-2-thumb.jpg')}}"
                                                    alt="product desc">
                                            </a>
                                        </div><!-- End .product-nav -->
                                    </div><!-- End .product-body -->
                            ...
                            <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                                <div class="product product-7 text-center">
                                    ...
                                    <div class="product-body">
                                        ...
                                        <div class="product-nav product-nav-thumbs">
                                            <a href="#" class="active">
                                                <img src="{{asset('public/frontend/assets/images/products/product-14-thumb.jpg')}}"
                                                    alt="product desc">
                                            </a>
                                            <a href="#">
                                                <img src="{{asset('public/frontend/assets/images/products/product-14-2-thumb.jpg')}}"
                                                    alt="product desc">
                                            </a>
                                            <a href="#">
                                                <img src="{{asset('public/frontend/assets/images/products/product-14-3-thumb.jpg')}}"
                                                    alt="product desc">
                                            </a>
                                        </div><!-- End .product-nav -->
                                    </div><!-- End .product-body -->
                            ...
                            <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                                <div class="product product-7 text-center">
                                    <figure class="product-media">
                                        <a href="product.html">
                                            <img src="{{asset('public/frontend/assets/images/products/product-15.jpg')}}"
                                                alt="Product image" class="product-image">
                                        </a>
                                    ...
                                    <div class="filter-items filter-items-count">
                                        <div class="filter-item">
                                            <div class="custom-control custom-checkbox">
                                                ...
                                                <label class="custom-control-label" for="cat-1">Computer & Laptops</label>
                                        ...
                                        <div class="filter-item">
                                            <div class="custom-control custom-checkbox">
                                                ...
                                                <label class="custom-control-label" for="cat-3">Smart Phones</label>
                                            </div><!-- End .custom-checkbox -->
                                        ...
                                        <div class="filter-item">
                                            <div class="custom-control custom-checkbox">
                                                ...
                                                <label class="custom-control-label" for="cat-4">Televisions</label>
                                            </div><!-- End .custom-checkbox -->
                                        ...
                                        <div class="filter-item">
                                            <div class="custom-control custom-checkbox">
                                                ...
                                                <label class="custom-control-label" for="cat-5">Cooking</label>
                                            </div><!-- End .custom-checkbox -->
                                            <span class="item-count">2</span>
                                        </div><!-- End .filter-item -->
                                        ...
                                        <div class="filter-item">
                                            <div class="custom-control custom-checkbox">
                                                ...
                                                <label class="custom-control-label" for="cat-6">Furnitures</label>
                                            </div><!-- End .custom-checkbox -->
