                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="banner banner-overlay">
                                                            <a href="category.html" class="banner banner-menu">
                                                                <img src="{{asset('public/frontend/assets/images/demos/demo-13/menu/banner-1.jpg')}}"
                                                                    alt="Banner">
                                                            </a>
                                            ...
                                            <div class="megamenu">
                                                <div class="row no-gutters">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="banner banner-overlay">
                                                            <a href="category.html" class="banner banner-menu">
                                                                <img src="{{asset('public/frontend/assets/images/demos/demo-13/menu/banner-2.jpg')}}"
                                                                    alt="Banner">
                                                            </a>
                                                        </div><!-- End .banner banner-overlay -->
                                                    </div><!-- End .col-md-4 -->
                                                ...
                                                <div class="menu-col">
                                                    ...
                                                    <div class="row menu-banners">
                                                        <div class="col-md-4">
                                                            <div class="banner">
                                                                <a href="#">
                                                                    <img src="{{asset('public/frontend/assets/images/demos/demo-13/menu/1.jpg')}}"
                                                                        alt="image">
                                                                </a>
                                                            </div><!-- End .banner -->
                                                        </div><!-- End .col-md-4 -->
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="banner">
                                                                <a href="#">
                                                                    <img src="{{asset('public/frontend/assets/images/demos/demo-13/menu/2.jpg')}}"
                                                                        alt="image">
                                                                </a>
                                                            </div><!-- End .banner -->
                                                        </div><!-- End .col-md-4 -->
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="banner">
                                                                <a href="#">
                                                                    <img src="{{asset('public/frontend/assets/images/demos/demo-13/menu/3.jpg')}}"
                                                                        alt="image">
                                                                </a>
                                                            </div><!-- End .banner -->
                                                        </div><!-- End .col-md-4 -->
                                            ...
                                            <div class="megamenu">
                                                <div class="row no-gutters">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="banner banner-overlay">
                                                            <a href="category.html" class="banner banner-menu">
                                                                <img src="{{asset('public/frontend/assets/images/demos/demo-13/menu/banner-3.jpg')}}"
                                                                    alt="Banner">
                                                            </a>
                                                        </div><!-- End .banner banner-overlay -->
                                                    </div><!-- End .col-md-4 -->
                                                ...
                                                <div class="menu-col menu-brands">
                                                    <div class="row">
                                                        <div class="col-lg-2">
                                                            <a href="#" class="brand">
                                                                <img src="{{asset('public/frontend/assets/images/brands/1.png')}}"
                                                                    alt="Brand Name">
                                                            </a>
                                                        </div><!-- End .col-lg-2 -->
                                                        ...
                                                        <div class="col-lg-2">
                                                            <a href="#" class="brand">
                                                                <img src="{{asset('public/frontend/assets/images/brands/2.png')}}"
                                                                    alt="Brand Name">
                                                            </a>
                                                        </div><!-- End .col-lg-2 -->
                                                        ...
                                                        <div class="col-lg-2">
                                                            <a href="#" class="brand">
                                                                <img src="{{asset('public/frontend/assets/images/brands/3.png')}}"
                                                                    alt="Brand Name">
                                                            </a>
                                                        </div><!-- End .col-lg-2 -->
                                                        ...
                                                        <div class="col-lg-2">
                                                            <a href="#" class="brand">
                                                                <img src="{{asset('public/frontend/assets/images/brands/4.png')}}"
                                                                    alt="Brand Name">
                                                            </a>
                                                        </div><!-- End .col-lg-2 -->
                                                        ...
                                                        <div class="col-lg-2">
                                                            <a href="#" class="brand">
                                                                <img src="{{asset('public/frontend/assets/images/brands/5.png')}}"
                                                                    alt="Brand Name">
                                                            </a>
                                                        </div><!-- End .col-lg-2 -->
                                                        ...
                                                        <div class="col-lg-2">
                                                            <a href="#" class="brand">
                                                                <img src="{{asset('public/frontend/assets/images/brands/6.png')}}"
                                                                    alt="Brand Name">
                                                            </a>
                                                        </div><!-- End .col-lg-2 -->
                                                    </div><!-- End .row -->
