                            ...
                            <div class="row">
                                <div class="col-md-6 col-lg-7">
                                    <div class="product-gallery">
                                        <figure class="product-main-image">
                                            ...
                                            <img id="product-zoom"
                                                src="{{asset('public/frontend/assets/images/products/single/fullwidth/3.jpg')}}"
                                                data-zoom-image="{{asset('public/frontend/assets/images/products/single/fullwidth/3-big.jpg')}}"
                                                alt="product image">
                                ...
                                <div class="col-md-6 col-lg-5">
                                    <div class="product-details">
                                        <h1 class="product-title">Beige ring handle circle cross body bag</h1>
                                        <!-- End .product-title -->
                                                    ...
                                                    <div class="card-body">
                                                        <div class="product-desc-content">
                                                            <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit.
                                                                ...
                                                                erat ut
                                                                turpis. Suspendisse urna viverra non, semper suscipit,
                                                                posuere
                                                                    ...
                                                                    <div class="col">
                                                                        ...
                                                                        <div class="review-content">
                                                                            <p>Lorem ipsum dolor sit amet, consectetur
                                                                                ...
                                                                                assumenda
                                                                                asperiores facilis porro reprehenderit
                                                                                animi
                                                                    ...
                                                                    <div class="col">
                                                                        ...
                                                                        <div class="review-content">
                                                                            <p>Sed, molestias, tempore? Ex dolor esse
                                                                                ...
                                                                                iste amet.
                                                                                Cum non voluptate eos enim, ab cumque
                                                                                nam, modi,
