    ...
    <div class="row g-4">
        ...
        <div class="col-sm-12 col-xl-6">
            <div class="bg-light rounded h-100 p-4">
                ...
                <form class="form" method="post" enctype="multipart/form-data" action="{{route('stocks.update')}}">
                    @csrf
                    @method('PATCH')

                    <div class="form-group mb-2">
                        <label for="product_id" class="form-label">Products Name</label><br>
                        <select class="form-select" id="product" aria-label="products" name="productsName_en">
                            <option value="">Select Product</option>
                            @forelse($product as $p)
                            <option value="{{$p->id}}" {{ old('productsName_en',$stock->product_id
                                )==$p->id?"selected":""}}>
                                {{ $p->name_en}}
                            </option>
                            @empty
                    ...
                    <div class="mb-2">
                        ...
                        <input type="text" class="form-control" id="totalQuantity"
                            value="{{ old('totalQuantity',$stock->total_quantity)}}" name="totalQuantity">
                    ...
                    <div class="mb-2">
                        ...
                        <input type="text" class="form-control" id="orderedQuantity"
                            value="{{ old('orderQuantity',$stock->order_quantity)}}" name="orderedQuantity">
                    ...
                    <div class="mb-2">
                        ...
                        <input type="text" class="form-control" id="buyingPrice"
                            value="{{ old('buyingPrice',$stock->buying_price)}}" name="buyingPrice">
                    ...
                    <div class="mb-2">
                        ...
                        <input type="text" class="form-control" id="buyingPrice"
                            value="{{ old('sellingPrice',$stock->selling_price)}}" name="sellingPrice">
