            ...
            <div class="bg-light rounded h-100 p-4">
                ...
                <form class="form" method="post" enctype="multipart/form-data" action="{{route('products.store')}}">
                    ...
                    <div class="mb-2">
                        ...
                        <input type="text" class="form-control" id="name_en" value="{{ old('productsName_en')}}"
                            name="productsName_en">
                    ...
                    <div class="mb-2">
                        ...
                        <textarea class="form-control" id="shortDescription"
                            value="{{ old('shortDescription')}}" name="shortDescription"></textarea>
                    ...
                    <div class="form-group mb-2">
                        ...
                        <select class="form-select" id="category" aria-label="Categories" name="categoryId">
                            ...
                            <option value="{{$c->id}}" {{ old('categoryId')==$c->id?"selected":""}}> {{ $c->name_en}}
                            </option>
                            @empty
                    ...
                    <div class="form-group mb-2">
                        ...
                        <select class="form-select" id="brand" aria-label="Brands" name="brandId">
                            ...
                            @forelse($brand as $b)
                            <option value="{{$b->id}}" {{ old('brandId')==$b->id?"selected":""}}> {{ $b->name_en}}
                            </option>
                            @empty
                    ...
                    <div class="form-group mb-2">
                        ...
                        <select class="form-select" id="status" aria-label="status" name="discountType">
                            <option value="1" @if(old('discountType')==1) selected @endif>Percentage</option>
                            <option value="2" @if(old('discountType')==2) selected @endif>Fixed</option>
                        </select>
                    ...
                    <div class="mb-2">
                        ...
                        <input type="text" class="form-control" id="contact_no_en" value="{{ old('discountAmount')}}" name="discountAmount">
                    ...
                    <div class="form-group mb-2">
                        ...
                        <select class="form-select" id="isPopular" aria-label="isPopular" name="isPopular">
                            <option value="1" @if(old('isPopular')==1) selected @endif>Yes</option>
                            <option value="0" @if(old('isPopular')==0) selected @endif>No</option>
                        </select>
                    ...
                    <div class="form-group mb-2">
                        ...
                        <select class="form-select" id="isFeatured" aria-label="isFeatured" name="isFeatured">
                            <option value="1" @if(old('isFeatured')==1) selected @endif>Yes</option>
                            <option value="0" @if(old('isFeatured')==0) selected @endif>No</option>
                        </select>
