            ...
            <div class="bg-light rounded h-100 p-4">
                ...
                <form class="form" method="post" enctype="multipart/form-data" action="{{route('coupon.store')}}">
                    ...
                    <div class="mb-2">
                        ...
                        <input type="text" class="form-control" id="code" value="{{ old('code', $coupon->code)}}"
                            name="code">
                        @if($errors->has('code'))
                    ...
                    <div class="mb-2">
                        ...
                        <input type="text" class="form-control" id="discount" value="{{ old('discount',$coupon->discount)}}"
                            name="discount">
