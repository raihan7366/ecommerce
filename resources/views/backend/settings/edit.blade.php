        ...
        <div class="col-sm-12 col-xl-6">
            <div class="bg-light rounded h-100 p-4">
                ...
                <form class="form" method="post" enctype="multipart/form-data"
                    action="{{route('settings.update',encryptor('encrypt',$setting->id))}}">
                    @csrf
                    @method('PATCH')
                
                    <div class="mb-2">
                        <label for="company_add" class="form-label">Company Address</label>
                        <input type="text" class="form-control" id="company_add"
                            value="{{ old('companyAddress', $setting->company_add)}}" name="companyAddress">
                    ...
                    <div class="mb-2">
                        ...
                        <input type="text" class="form-control" id="contactNumber"
                            value="{{ old('contactNumber', $setting->contact_no_en)}}" name="contactNumber">
                    ...
                    <div class="mb-2">
                        ...
                        <input type="text" class="form-control" id="facebookLink" value="{{ old('facebookLink',$setting->facebook_link)}}" name="facebookLink">
                    ...
                    <div class="mb-2">
                        ...
                        <input type="text" class="form-control" id="twitterLink" value="{{ old('twitterLink',$setting->twitter_link)}}" name="twitterLink">
                    ...
                    <div class="mb-2">
                        ...
                        <input type="text" class="form-control" id="whatsappLink" value="{{ old('whatsappLink',$setting->whatsapp_link)}}" name="whatsappLink">   
